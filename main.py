...
# Converting to gray
img_original = cv2.imread('Pictures/Aslan.jpg',)
...
#
# img = cv2.imread('Pictures/Manzara.jpg')
#
...
#
# # Prewitt Algorithm
# img = cv2.imread('Pictures/Aslan.jpg')
...
#
# #Sobel
# img_original = cv2.imread('Pictures/Tablo.jpg',)
# gray_scale = cv2.cvtColor(img_original, cv2.COLOR_BGR2GRAY)
#
...
#
# img = cv2.imread('Pictures/Tablo.jpg')
#
...
# 							[ -1, 0 ]] )
#
# img = cv2.imread('Pictures/Manzara.jpg', 0).astype('float64')
# img/=255.0
